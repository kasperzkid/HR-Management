        ...
        <div className="px-6 pb-6 pt-0 relative">
          <div className="flex justify-between items-end -mt-10 mb-4">
            <img
              src={employee.avatar}
              alt={employee.name}
              className="w-20 h-20 rounded-2xl object-cover border-4 border-white shadow-md bg-gray-100"
              onError={(e) => {
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-950">{employee.name}</h2>
          ...
          <div className="mt-5 grid grid-cols-2 gap-3">
            <div className="p-3 rounded-xl bg-gray-50 border border-gray-100 flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs font-medium text-gray-800 truncate">{employee.email}</p>
              </div>
            </div>
            ...
            <div className="p-3 rounded-xl bg-gray-50 border border-gray-100 flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-[10px] uppercase font-semibold text-gray-400">Phone</p>
                <p className="text-xs font-medium text-gray-800 truncate">{employee.phone || '+1 (555) 000-0000'}</p>
              </div>
            </div>
            ...
            <div className="p-3 rounded-xl bg-gray-50 border border-gray-100 flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs font-medium text-gray-800 truncate">{employee.location || 'Remote'}</p>
              </div>
            </div>
            ...
            <div className="p-3 rounded-xl bg-gray-50 border border-gray-100 flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-[10px] uppercase font-semibold text-gray-400">Join Date</p>
                <p className="text-xs font-medium text-gray-800 truncate">{employee.joinDate}</p>
              </div>
            </div>
            ...
            <div className="p-3 rounded-xl bg-gray-50 border border-gray-100 flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-[10px] uppercase font-semibold text-gray-400">Department</p>
                <p className="text-xs font-medium text-gray-800 truncate">{employee.department}</p>
              </div>
            </div>
            ...
            <div className="p-3 rounded-xl bg-gray-50 border border-gray-100 flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-[10px] uppercase font-semibold text-gray-400">Compensation</p>
                <p className="text-xs font-medium text-gray-800 truncate">{employee.salary || '$95,000 / yr'}</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-5 pt-4 border-t border-gray-100">
            <p className="text-xs font-semibold text-gray-700 mb-2">Change Status</p>
