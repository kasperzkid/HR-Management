...
function Inbox({ basePath = '/employer/inbox', canStartChat = false }) {
  ...
  const handleFile = async (file) => {
    ...
    setUploading(true)
    try {
      await sendAttachment(activeContactId, file)
    } finally {
      setUploading(false)
                ...
                {messages.map((msg) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        tabIndex={-1}
                        className={`max-w-[75%] sm:max-w-[65%] px-4 py-2.5 text-xs border-0 outline-none select-text ${
                          mine
                        ...
                        {att && (
                          <div className="mb-2">
                            {isImage ? (
                              ...
                              <div className="flex items-center gap-2 p-2 rounded-lg bg-black/10 dark:bg-white/10 text-xs">
                                <FileText size={14} />
